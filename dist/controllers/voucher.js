...
exports.voucher = {
    voucherApi: (request, h) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    setMaxQuantity: (request, h) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    genNewVoucher: (request, h) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            var error;
